        ...
        <div style={{ width: "100%", maxWidth: "400px", paddingTop: "1.5rem" }}>
          ...
          <a
            ...
            style={{
              ...
              borderRadius: "0.875rem", border: "1.5px solid #e2e8f0",
              background: "white", color: "#374151", fontWeight: 600, fontSize: "0.9375rem",
              textDecoration: "none", cursor: "pointer", transition: "border-color 0.15s, box-shadow 0.15s",
            }}
            onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#7c6ff7"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(124,111,247,0.1)"; }}
